...
_REQUIRED_INSTRUCTIONS: dict[str, str] = {
    "two_by_two": (
        ...
        "(aim for 4-6 items; minimum 2 if evidence supports fewer) where each item is "
        "{name, quadrant ∈ {bottom_left, bottom_right, top_left, top_right}, rationale "
        "≥20 chars, evidence_citations (list of ≥1 claim_id from key_claims)}; "
        "interpretation (str ≥30 chars, the narrative reading of the cluster pattern). "
        "For M&A diligence default to x_axis_label='Strategic fit', "
